/**
 * Config Subpath Validation (Next.js 15.3.8)
 *
 * Validates that `@electroplix/components/config` is server-safe.
 * The config entry point must NOT include the "use client" directive
 * and must not depend on React.
 */
...
export default function ConfigPage() {
  return (
    <main style={{ maxWidth: 720, margin: '0 auto', padding: '2rem' }}>
      <h1>Config Subpath Validation — Next.js 15.3.8</h1>
      <pre
        style={{
          background: '#0b0b0c',
          color: '#f3f4f6',
