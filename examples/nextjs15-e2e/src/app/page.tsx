/**
 * SSR Validation Page (Next.js 15.3.8)
 *
 * This page renders one component from every category as a React Server
 * Component. If any component touches `window`/`document` at import time
 * or render time on the server, `next build` will throw and CI will fail.
 *
 * 18 categories × 1 representative each = 18 components exercised in SSR.
 */
import {
  Accordion,
  AvatarProfile,
  ...
  return (
    <ElectroplixProvider>
      <main style={{ maxWidth: 960, margin: '0 auto', padding: '2rem' }}>
        <h1>SSR Validation — Next.js 15.3.8</h1>
        <p>
          Each section below renders a representative component from one of the 18 categories on the
          server. If this page builds, the package is SSR-safe on Next.js 15.3.8.
        </p>
