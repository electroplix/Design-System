...
import {
  BlogCard, AuthorByline, TagList, BlogBadge,
  ReadingBar, ArticleRenderer, RelatedPosts,
  ArchiveList, CommentsSection,
...
describe("Blog components", () => {
  ...
  it("ArchiveList renders", () => {
    const { container } = wrap(
      <ArchiveList groups={[{ label: "2024", posts: [samplePost] }]} />
    );
    expect(container.firstChild).toBeTruthy();
  });
