        ...
        <div style={{ position: 'relative' as const }}>
          <button
            ...
            style={{
              ...
              borderRadius: radius,
              border: `1px solid ${isFocused || isOpen ? accentColor : borderColor}`,
              background: inputBg,
              color: sel ? textColor : 'rgba(255,255,255,0.5)',
              fontSize: selectSize,
              textAlign: 'left' as const,
              cursor: 'pointer',
              outline: 'none',
              transition: 'all 0.2s ease',
              boxShadow: isFocused || isOpen ? `0 0 0 3px ${accentColor}20` : 'none',
              ...
              {safeOpts.map((opt) => (
                <button
                  ...
                  style={{
                    ...
                    background: current === opt.value ? `${accentColor}15` : 'transparent',
